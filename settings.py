...
# comentarios explicativos (minimos)
...
default_config = {
    ...
    # opcionales: cuadrante de entrenamiento y radio de asignacion de tareas
    "train_quadrant": None,
...
TRAIN_QUADRANT = config.get("train_quadrant", None)  # ejemplo: [xmin, ymin, xmax, ymax] o None
TASK_ASSIGN_RADIUS = config.get("task_assign_radius", None)  # opcional: limitar asignaciones por distancia
...
print(f"[SETTINGS] obstacles(grid)={sorted(list(OBSTACLES))} task_assign_radius={TASK_ASSIGN_RADIUS}")
